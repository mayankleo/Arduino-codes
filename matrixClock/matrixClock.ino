...
// pin 4 is connected to the DataIn on the display
// pin 5 is connected to the CLK on the display
// pin 6 is connected to CS on the display
LedControl lc = LedControl(4, 5, 6, 4); //sets the 3 pins as 4, 5 & 6 and then sets 4 displays (max is 8 displays)
